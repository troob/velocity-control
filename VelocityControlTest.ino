...
//    else if(inputString.substring(0,1) == "t") // given in deg
//    { 
...
//    locateTarget();
  ...
  if(setVelActive)
  {
    ...
    cmdAngVel = setAngVel; // if set pos inactive; needs to be before computing mtr ctrl sgnl
